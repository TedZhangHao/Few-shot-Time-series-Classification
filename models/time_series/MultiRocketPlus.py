...
class MultiRocketPlus(nn.Sequential):
    ...
    def __init__(self, configs):
        ...
        d = None
        num_features = configs.Multi_num_features
        max_dilations_per_kernel = configs.Multi_max_dilations_per_kernel
        kernel_size = configs.Multi_kernel_size
        max_num_channels = configs.Multi_max_num_channels
        max_num_kernels = configs.Multi_kernel_size
        use_bn = True
        fc_dropout = 0
        custom_head = None
        zero_init = True
