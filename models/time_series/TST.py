...
class TST(Module):
    def __init__(self, configs, dropout:float=0.1, act:str="gelu", fc_dropout:float=0.,
                 y_range:Optional[tuple]=None, verbose:bool=False, **kwargs):
        c_in = configs.enc_in
        c_out = configs.num_class
        seq_len = configs.seq_len
        max_seq_len = configs.TST_max_seq_len
        n_layers = configs.TST_n_layers
        d_model = configs.TST_d_model
        n_heads = configs.TST_n_heads
        d_k = configs.TST_d_k
        d_v = configs.TST_d_v
        d_ff = configs.TST_d_ff
